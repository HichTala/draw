...
def build_classification(card_types, configs, data_path, deck_list, device):
    ...
    for card_type in card_types:
        model_classification_dict[card_type] = create_model(
            'beit_base_patch16_224',
            pretrained=False,
            num_classes=configs[card_type]["num_classes"],
            drop_rate=0,
            drop_path_rate=0.1,
            attn_drop_rate=0,
        ...
        classes.sort()
        classes_dict[card_type] = classes

        deck_card_ids[card_type] = clean_deck_list(deck_list, card_type, classes)
